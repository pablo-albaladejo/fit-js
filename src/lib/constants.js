const constants = {
  ...
  types: {
    ...
    fit_base_type: {
      0: { name: 'enum', bytes: 1, },
      1: { name: 'sint8', bytes: 1 },
      2: { name: 'uint8', bytes: 1 },
      7: { name: 'string', bytes: 1 },
      10: { name: 'uint8z', bytes: 1 },
      13: { name: 'byte', bytes: 1 },
      131: { name: 'sint16', bytes: 2 },
      132: { name: 'uint16', bytes: 2 },
      133: { name: 'sint32', bytes: 4 },
      134: { name: 'uint32', bytes: 4 },
      136: { name: 'float32', bytes: 4 },
      137: { name: 'float64', bytes: 8 },
      139: { name: 'uint16z', bytes: 2 },
      140: { name: 'uint32z', bytes: 4 },
    },
    turn_type: {
      0: 'arriving_idx',
      1: 'arriving_left_idx',
